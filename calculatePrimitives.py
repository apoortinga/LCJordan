...
class primitives():
	...
	def createPrimitive(self,spring,summer,autumn,winter,trainingDataSet,y):
		...
		classNames = ee.List(["water","imperv","forest","fieldcrops","olives","citrus","dade","barren","snow"]);
...
if __name__ == "__main__":
	...
	trainingData = ee.FeatureCollection("ft:1wroAl7x6O1AedIbnP5NtZHTa0zTJUY6eWZSt1nYS")
